...
<body class="mt-2">
    ...
    <div class="col-12 text-center">
      <div class="row">
        ...
        <div class="col-3 text-left">
          <strong>Presentar Ordenes</strong>
        </div>
        @foreach($customers as $customer)
          ...
          <div class="col-3 text-left mt-2">
            <button value="{{$customer->customer_id}}" onclick="orden(value)" class="btn btn-info" data-toggle="modal" data-target="#exampleModal">Fecha Asc</button>
            <button value="{{$customer->customer_id}}" onclick="orden2(value)" class="btn btn-info" data-toggle="modal" data-target="#exampleModal">Fecha Desc</button>
          </div>
        @endforeach
        <div class="col-12">
